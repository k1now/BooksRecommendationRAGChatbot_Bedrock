...
const App = () => {
    const [messages, setMessages] = React.useState([
        { text: "Hello! What kind of book are you thinking of exploring next?", isUser: false, timestamp: Date.now() }
    ]);
    ...
    return React.createElement('div', {
        ...
        }, React.createElement('h1', null, 'Book Recommendation ChatBot')),
